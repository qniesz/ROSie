...
# ── Defaults (Pi Zero 2 W paths — override by passing explicit args) ──────────
DEFAULT_MAP_YAML = Path(os.environ.get("ROSIE_MAP_DIR", "/home/rosie/maps")) / "home.yaml"
DEFAULT_OUT      = Path(os.environ.get("ROSIE_MAP_DIR", "/home/rosie/maps")) / "home_clean.png"
DEFAULT_META_OUT = Path(os.environ.get("ROSIE_MAP_DIR", "/home/rosie/maps")) / "home_meta.json"
